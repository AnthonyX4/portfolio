                ...
                >
                    ...
                    <AnimatePresence>
                        {hovered &&
                            ...
                            <motion.svg initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { duration: 0.3 } }} exit={{ opacity: 0, transition: { duration: 0.3 } }}className={styles.hat} width="12.5rem" height="12.5rem" viewBox="0 0 694 304" fill="none" xmlns="http://www.w3.org/2000/svg">
